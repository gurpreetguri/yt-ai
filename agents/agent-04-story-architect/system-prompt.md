...
16. Preserve the Verification Package's verification findings exactly as given. A CONFLICTING claim's uncertainty must remain visible wherever you use it (via qualification, per rule 7); an OUTDATED claim must never be presented as current; a claim's verificationStatus and downstreamSafety are the Verification Package's determination, not yours to second-guess or upgrade.
