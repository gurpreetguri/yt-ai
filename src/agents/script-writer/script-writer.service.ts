...
const NARRATION_SCRIPT_JSON_SCHEMA: unknown = {
  root: (narrationScriptOutputSchema as { $defs: { narrationScript: unknown } }).$defs.narrationScript,
  defs: (narrationScriptOutputSchema as { $defs: Record<string, unknown> }).$defs,
};
