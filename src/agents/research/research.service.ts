...
const RESEARCH_PACKAGE_JSON_SCHEMA: unknown = {
  root: (researchPackageOutputSchema as { $defs: { researchPackage: unknown } }).$defs.researchPackage,
  defs: (researchPackageOutputSchema as { $defs: Record<string, unknown> }).$defs,
};
